package com.arkaapps.puttaraj.services;
...
import com.arkaapps.puttaraj.NotificationFCM;
...
public class MyFirebaseMessagingService extends FirebaseMessagingService {
    ...
    public void onMessageReceived(RemoteMessage remoteMessage) {
        ...
        if (remoteMessage.getNotification() != null) {
            Log.e(TAG, "NotificationFCM Body: " + remoteMessage.getNotification().getBody());
    ...
    private void handleNotification(String message) {
        if (!NotificationUtil.isAppIsInBackground(getApplicationContext())) {
            ...
            Intent pushNotification = new Intent(NotiConstant.PUSH_NOTIFICATION);
    ...
    private void handleDataMessage(JSONObject json) {
        ...
        try {
            ...
            if (!NotificationUtil.isAppIsInBackground(getApplicationContext())) {
                ...
                Intent resultIntent = new Intent(getApplicationContext(), NotificationFCM.class);
