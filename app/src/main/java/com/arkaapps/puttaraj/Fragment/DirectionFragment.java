...
public class DirectionFragment extends FragmentActivity implements OnMapReadyCallback {
    ...
    private void initGoogleAPIClient() {
        ...
        mGoogleApiClient = new GoogleApiClient.Builder(DirectionFragment.this)
    ...
    private void checkPermissions() {
        if (Build.VERSION.SDK_INT >= 23) {
            if (ContextCompat.checkSelfPermission(DirectionFragment.this,
    ...
    private void requestLocationPermission() {
        if (ActivityCompat.shouldShowRequestPermissionRationale(DirectionFragment.this, android.Manifest.permission.ACCESS_FINE_LOCATION)) {
            ActivityCompat.requestPermissions(DirectionFragment.this,
                ...
                switch (status.getStatusCode()) {
                    ...
                    case LocationSettingsStatusCodes.RESOLUTION_REQUIRED:
                        ...
                        try {
                            ...
                            status.startResolutionForResult(DirectionFragment.this, REQUEST_CHECK_SETTINGS);
    ...
    protected void onResume() {
        super.onResume();
        registerReceiver(gpsLocationReceiver, new IntentFilter(BROADCAST_ACTION));//R
    }
        ...
        switch (requestCode) {
            case ACCESS_FINE_LOCATION_INTENT_ID: {
                ...
                if (grantResults.length > 0
                    ...
                    Toast.makeText(DirectionFragment.this, "Locatio Permeission denied.", Toast.LENGTH_SHORT).show();
